...
*/
    ...
    #define CURSOR_COLOR TFT_RED
    #define CURSOR_COLOR_MENU_DYN TFT_RED
    #define CURSOR_POSITION_EXT 100
    #define CURSOR_POSITION_INT 98
    #define CURSOR_MENU_DYN_POSITION_EXT 75     //78
    #define CURSOR_MENU_DYN_POSITION_INT 73     //76
